...
diagrams-js now includes [TanStack Intent](https://github.com/tanstack/intent) skills for enhanced AI-assisted development. These skills provide specialized guidance for common tasks and help prevent common mistakes.
:::
...
The TanStack Intent skills are located in `.agents/skills/` and include:

- **10 specialized skills** covering all aspects of diagrams-js
- **24 failure modes** with wrong/correct code examples
- **Cross-references** between related skills
- **Framework-specific** guidance for browser and Node.js environments

To contribute to skills or learn more about the skill structure:

- See [Skill Specification](https://github.com/hatemhosny/diagrams-js/blob/main/.agents/skills/_artifacts/skill_spec.md)
- Review [Domain Map](https://github.com/hatemhosny/diagrams-js/blob/main/.agents/skills/_artifacts/domain_map.yaml)
- Check [Skill Tree](https://github.com/hatemhosny/diagrams-js/blob/main/.agents/skills/_artifacts/skill_tree.yaml)
