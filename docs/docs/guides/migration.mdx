...
- [Examples](/guides/examples) - More examples
- [API Reference](/guides/api) - Complete API
- [GitHub Issues](https://github.com/author/diagrams-js/issues) - Report issues

## Credits

Migration guide for the TypeScript port of [diagrams](https://github.com/mingrammer/diagrams) by [mingrammer](https://github.com/mingrammer).
