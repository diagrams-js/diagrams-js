...
An edge object contains attributes like **label**, **color**, and **style**. These mirror the corresponding [Graphviz edge attributes](https://graphviz.org/doc/info/attrs.html).
...
const diagram = Diagram("Advanced Web Service", { direction: "TB" });
...
See [Graphviz edge attributes](https://graphviz.org/doc/info/attrs.html) for the complete list.

## Credits

Edge styling based on [Graphviz](https://graphviz.org/) attributes and the original [diagrams](https://github.com/mingrammer/diagrams) library.
