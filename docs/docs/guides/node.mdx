...
See the [Providers](/providers/) section for a complete list.
...
Node icons and design patterns based on the original [diagrams](https://github.com/mingrammer/diagrams) library by [mingrammer](https://github.com/mingrammer).
