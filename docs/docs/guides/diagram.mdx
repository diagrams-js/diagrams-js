...
See [Graphviz attributes reference](https://graphviz.org/doc/info/attrs.html) for available options.
...
Uses [Graphviz](https://graphviz.org/) for layout and rendering via [viz-js](https://github.com/mdaines/viz-js).
