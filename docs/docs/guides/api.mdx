...
See [Providers](/providers/) for complete list.
...
API design based on the original [diagrams](https://github.com/mingrammer/diagrams) Python library by [mingrammer](https://github.com/mingrammer), adapted for TypeScript/JavaScript with factory functions.
